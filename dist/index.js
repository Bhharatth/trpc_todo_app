...
mongoose_1.default.connect('mongodb+srv://bharath:12345@todo.tsdegdt.mongodb.net/?retryWrites=true&w=majority', { dbName: "todo" });
            ...
            return new Promise((resolve) => {
                jsonwebtoken_1.default.verify(token, exports.SECRET, (err, user) => {
                    if (user) {
                        ...
                        resolve({ userId, db: { Todo: db_1.Todo, User: db_1.User } });
                    }
                    else {
