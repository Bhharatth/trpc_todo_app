...
exports.todoRouter = (0, trpc_1.router)({
    todoCreate: trpc_1.publicProcedure.input(zod_1.z.object({
        title: zod_1.z.string(),
        description: zod_1.z.string()
    })).use(user_1.isLoggedIn).mutation((opts) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    todoGet: trpc_1.publicProcedure.output(zod_1.z.array(zod_1.z.object({
        title: zod_1.z.string(),
        description: zod_1.z.string(),
        done: zod_1.z.boolean()
    }))).use(user_1.isLoggedIn).query((opts) => __awaiter(void 0, void 0, void 0, function* () {
